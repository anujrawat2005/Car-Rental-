  ...
  return (
    ...
    `}>
      ...
      <div className={`max-sm:fixed  max-sm:h-screen max-sm:w-full max-sm:top-16 max-sm:border-t border-borderColor
        right-0 flex flex-col sm:flex-row sm:items-center sm:gap-8 max-sm:p-4 transition-all duration-300 z-50 
        ${location.pathname=== '/' ? "bg-light" : "bg-white"} ${open ? "max-sm:translate-x-0" : "max-sm:translate-x-full"}`}>
            ...
            rounded-full max-w-56'>
              <input type='text' placeholder="Search Product" className='py-1.5 w-full bg-transparent outline-none
            ...
            <div>
              ...
              <button
               ...
               className="cursor-pointer px-8 py-1 bg-primary hover:bg-primary-dull transition-all text-white
