  ...
  return (
    ...
    transition={{ duration:0.8}}
     className='h-screen flex flex-col items-center justify-center gap-14 bg-light text-center'>
        ...
        bg-white shadow-[0px_8_px_20px_rgba(0,0,0,0.1)]'>
          <div className=' flex flex-col md:flex-row itema-start md:items-center gap-10 min-md:ml-8'>
            ...
            <div className='flex flex-col items-center gap-2'>
              ...
              <input value={returnDate} onChange={e=>setReturnDate(e.target.value)} type="date"  id="return date"  className='text-sm text-gary-500' required/>
            </div>
          ...
          max-sm:mt-4 bg-primary hover:big-primary-dull text-white rounded-full cursor-pointer'>
