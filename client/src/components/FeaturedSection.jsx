...
const FeaturedSection = () => {
    ...
    xl:px-32'>
      ...
      >
        <Title title="Featured vehicle" subTitle = 'Explore all our premium vechicles available  for next adventure'/>
      ...
      transition = {{delay:0.5 ,duration:1}}
       className="grid grid-cols-2 lg:grid-cols-3 gap-8 mt-18 ">
        {
