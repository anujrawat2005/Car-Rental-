...
const AddCar = () => {
  ...
  return (
    <div className="px-4 py-10 md:px-10 flex-1" >
      <Title title="Add New Car" subTitle="Fill in details to list a new car for booking,including prices,availability,and
      car specification"/>
      ...
      <form onSubmit={onSubmitHandler} className="flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3  gap-6">
          <div className="flex flex-col w-full">
            ...
            <select onChange={e=>setCar({...car,transmission:e.target.value})} value={car.transmission}
              className="px-3 py-2 mt-1 border border-borderColor rounded-md outline-none ">
                ...
                <option value="SUV">Semi-Automatic</option>
                <option value="Van">Manual</option>
          ...
          {/*Car Description */}
            ...
            <textarea  rows={5} placeholder= "A luxirios SUV with spacious interior and Powerful engine" required
            className=" px-3 py-2 mt-1 border border-borderColor rounded-md outline-none" 
